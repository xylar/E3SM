...
static void defineAllTracers() {
   ...
   define("Debug1", "Debug Tracer 1", "", "", 0.0, 100.0, FillValueReal);
   define("Debug2", "Debug Tracer 2", "", "", 0.0, 100.0, FillValueReal);
   define("Debug3", "Debug Tracer 3", "", "", 0.0, 100.0, FillValueReal);
}
```
